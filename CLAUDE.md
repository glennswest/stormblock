...
Build host: root@devx.gw.lo (192.168.1.53), CT 102 on pvex.gw.lo (192.168.1.160). 40GB /build disk for cargo target directory. DNS: 192.168.1.252, 192.168.1.154 (dns.gw.lo).
