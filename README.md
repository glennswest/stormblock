...
One binary, `stormblock` (v19.1.3). It is a daemon, an initramfs boot agent
...
| `docs/presentation.md` | an 11-slide deck: purpose, where it sits, what works, interfaces, shipping, status (Marp) |
